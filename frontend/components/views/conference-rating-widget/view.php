    ...
    <table class="table td-width sm-table-layout-auto md-change-size">
        ...
        foreach ($items as $key => $item): ?>
            ...
            <tr>
                ...
                <td>
                    <div class="md-hidden"> <?= \yii\helpers\Html::a($item["name"], $widget->getConferenceLink($item["alias"])) ?></div>
                    <div class="md-visible">
                        ...
                        <div id="row-<?= $index ?>" class="content">
                            ...
                            <a href="<?= $widget->getConferenceLink($item["alias"]) ?>" class="more-link">Подробнее<i class="icon icon-right-arrow"></i></a>
                        </div>
                    </div>
